                ...
                child: Opacity(opacity: isRead ? 0.65 : 1, child: Padding(
                  ...
                  child: isSmall
                    ...
                    ? Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                        ...
                        const SizedBox(height: 6),
                        Text(L.serverText(n['title'] ?? ''), style: GoogleFonts.tajawal(fontSize: 13, fontWeight: isRead ? FontWeight.w500 : FontWeight.w700, color: W.text), textAlign: TextAlign.right),
                        const SizedBox(height: 2),
                        Text(L.serverText(n['body'] ?? ''), style: GoogleFonts.tajawal(fontSize: 12, color: W.sub), textAlign: TextAlign.right),
                    ...
                    : Row(children: [
                        ...
                        Expanded(flex: 3, child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                            ...
                            _badge(_typeLabel[n['type']] ?? L.tr('info'), color, color.withOpacity(0.08)),
                            const SizedBox(width: 6),
                            Flexible(child: Text(L.serverText(n['title'] ?? ''), style: GoogleFonts.tajawal(fontSize: 14, fontWeight: isRead ? FontWeight.w500 : FontWeight.w700, color: W.text))),
                          ]),
                          const SizedBox(height: 2),
                          Text(L.serverText(n['body'] ?? ''), style: GoogleFonts.tajawal(fontSize: 12, color: W.sub), textAlign: TextAlign.right),
                        ])),

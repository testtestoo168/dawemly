                  ...
                  child: isSmall
                    ...
                    ? Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                        Row(children: [
                          ...
                          Container(width: 32, height: 32, decoration: BoxDecoration(color: color.withOpacity(0.08), borderRadius: BorderRadius.circular(6)), child: Icon(_typeIcon[n['type']] ?? Icons.info, size: 16, color: color)),
                        ]),
                        const SizedBox(height: 6),

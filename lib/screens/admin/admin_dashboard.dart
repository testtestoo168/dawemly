    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
        ...
        GridView.count(
          ...
          shrinkWrap: true, physics: const NeverScrollableScrollPhysics(),
          children: [
            _quickAction(Icons.wifi_tethering_rounded, 'إثبات الحالة', () => onNav('verify')),
            _quickAction(Icons.person_add_alt_1_rounded, 'إضافة موظف', () => onNav('usermgmt')),
            _quickAction(Icons.assignment_rounded, 'الطلبات المعلقة', () => onNav('requests')),
            _quickAction(Icons.bar_chart_rounded, 'التقارير', () => onNav('reports')),
          ],
        ),
        const SizedBox(height: 24),
        ...
        Container(
          ...
          child: Row(textDirection: TextDirection.rtl, children: [
            ...
            Material(
              ...
              child: InkWell(onTap: () => onNav('requests'), borderRadius: BorderRadius.circular(6),

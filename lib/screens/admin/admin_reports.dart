              ...
              child: ConstrainedBox(
                ...
                child: DataTable(
                  ...
                  rows: data.map((r) => DataRow(cells: [
                    ...
                    DataCell(Center(child: Text(r['early'] ?? '—', style: GoogleFonts.tajawal(fontSize: isWide ? 13 : 12, color: r['early'] != '—' ? W.orange : W.muted)))),
                    DataCell(Center(child: Text(r['late'] ?? '—', style: GoogleFonts.tajawal(fontSize: isWide ? 13 : 12, color: r['late'] != '—' ? W.red : W.muted)))),
                    DataCell(Center(child: Text('${r['hours']}h', style: _mono(fontSize: isWide ? 13 : 12, fontWeight: FontWeight.w600, color: W.text)))),
                    DataCell(Center(child: Text(r['checkOut'] ?? '—', style: _mono(fontSize: isWide ? 13 : 12, color: W.text)))),
